...
function loadCardBoardText(tasks_name, id) {
    ...
    <div id="card-head-${id}" class="card" id=card${id} draggable="true" ondragstart="startDragging(${id})" onclick="checkWhichMenu(${id}); event.stopPropagation();">
            ...
            <div class="popUpWishWindow d-none" id="contextMenu${id}">
                <div class="popUpWish">
                ...
                <div class="features-container">
                    ...
                    <div class="features-container">
                        ...
                        <div class="subtask-container">
                            <input class="subtask-input" onclick="subtaskImgClasses('add','remove','remove')"placeholder="Add new subtask" id="subtask"><img id="plusSubtaskImg" class="plus-icon" src="assets/img/plus-icon.png" onclick="changeSubIcon()">
                            <div class="subtask-img-container">
                                <img id="clearSubtaskImg" src="assets/img/icon_cancel_subtask.svg" onclick="subtaskImgClasses('add','remove','remove')" class="subtask-icons d-none">
    ...
    <div class="right-container">
        ...
        <div class="features-container">
            ...
            <div class="features-container">
                <label>Subtasks</label>
                <div class="subtask-container">
                    <input class="subtask-input" onclick="subtaskImgClasses('add','remove','remove')"placeholder="Add new subtask" id="subtask">
                    <img id="plusSubtaskImg" class="plus-icon" src="assets/img/plus-icon.png" onclick="subtaskImgClasses('add','remove','remove')">
                    <div class="subtask-img-container">
                        <img id="clearSubtaskImg" src="assets/img/icon_cancel_subtask.svg" onclick="clearSubtask()" class="subtask-icons d-none">
                        <div class="gap-img-subtask"></div>
                        <img id="addSubtaskImg" src="assets/img/icon_check_subtask.svg" onclick="addSubtask(0,${id})" class="subtask-icons d-none">
                    </div>
                </div>
                <div class="subtask-list">
                    <ul id="subtask-list"></ul>
