            ...
            <div class="contact-input-container margin-top">
                ...
                <form onsubmit="updateContact(); return false;">
                    ...
                    <div class="form-group" style="display: flex; align-items: center;">
                        <input class="p-none"type="color" id="color" name="color" value="${selectedContact.color}" required><p style="padding: 0 5px;">Choose a Color</p>
                    </div>
                    ...
                    <div class="features-container">
                        ...
                        <div class="features-container">
                            ...
                            <div class="subtask-container">
                                ...
                                <img id="addSubtaskImg" src="assets/img/icon_check_subtask.svg" onclick="addSubtask(1)" class="subtask-icons d-none">
                                </div>
                            </div>
